...
const VERSION = '212d8c9a17';
const PREFIX = "markgames-";
const CACHE = PREFIX + VERSION;
const SCOPE = new URL(self.registration.scope);
const INDEX = new URL('index.html', SCOPE).href;
const ASSETS = ["./manifest.webmanifest","./apple-touch-icon.png","./favicon-64.png","./icon-192.png","./icon-512-maskable.png","./icon-512.png","./img/adventure-1.jpg","./img/adventure-2.jpg","./img/adventure-icon.png","./img/bitva-1.jpg","./img/bitva-2.jpg","./img/bitva-icon.png","./img/brain-1.jpg","./img/brain-icon.png","./img/draw-1.jpg","./img/draw-2.jpg","./img/draw-icon.png","./img/dustmaze-1.jpg","./img/dustmaze-2.jpg","./img/dustmaze-3.jpg","./img/dustmaze-icon.png","./img/emoplanet-1.jpg","./img/emoplanet-2.jpg","./img/emoplanet-3.jpg","./img/emoplanet-icon.png","./img/ghostlife-1.jpg","./img/ghostlife-2.jpg","./img/ghostlife-3.jpg","./img/ghostlife-icon.png","./img/kart-1.jpg","./img/kart-2.jpg","./img/kart-3.jpg","./img/kart-icon.png","./img/matshtorm-1.jpg","./img/matshtorm-2.jpg","./img/matshtorm-3.jpg","./img/matshtorm-icon.png","./img/nightshift-1.jpg","./img/nightshift-2.jpg","./img/nightshift-3.jpg","./img/nightshift-icon.png","./img/obzhora-1.jpg","./img/obzhora-2.jpg","./img/obzhora-icon.png","./img/party-1.jpg","./img/party-2.jpg","./img/party-icon.png","./img/phantom-1.jpg","./img/phantom-2.jpg","./img/phantom-icon.png","./img/spider-1.jpg","./img/spider-2.jpg","./img/spider-icon.png","./img/technobunt-1.jpg","./img/technobunt-2.jpg","./img/technobunt-3.jpg","./img/technobunt-icon.png"];
